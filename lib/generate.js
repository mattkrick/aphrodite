...
var _stringHandlers = require('./stringHandlers');

var _stringHandlers2 = _interopRequireDefault(_stringHandlers);
...
var runStringHandlers = function runStringHandlers(declarations) {
    ...
    Object.keys(declarations).forEach(function (key) {
        ...
        if (_stringHandlers2['default'][key]) {
            result[key] = _stringHandlers2['default'][key](declarations[key]);
        } else {
...
var generateCSSRuleset = function generateCSSRuleset(selector, declarations) {
    ...
    var rules = prefixedRules.map(function (_ref3) {
        ...
        return (0, _util.kebabifyStyleName)(key) + ':' + stringValue + ';';
    }).join("");
